...
const kebabCaseToFirstLetterUpperCase = (txt: string) => {
  return txt
    .split('-')
...
const mapLots = (): LotDTO[] => {
  return [...wcData, ...osData]?.map((lot: Lot) => ({
    id: lot.id,
    title: lot.title,
    ...
    world: {
      id: lot.worldId,
      title: kebabCaseToFirstLetterUpperCase(lot.worldId),
    },
    neighborhood: {
      id: lot.neighborhoodId,
      title: kebabCaseToFirstLetterUpperCase(lot.neighborhoodId),
    },
  }));
};
